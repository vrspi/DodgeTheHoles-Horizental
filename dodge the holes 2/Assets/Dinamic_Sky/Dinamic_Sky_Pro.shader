...
Shader "Dinamic_Sky/Dinamic_Sky" {
    Properties {
        [HDR]_SkyColor ("Sky Color", Color) = (0.03137255,0.09019608,0.1764706,1)
       [HDR]_HorizonColor ("Horizon Color", Color) = (0.06617647,0.5468207,1,1)
       ...
       [HDR]_CloudsColor ("Clouds Color", Color) = (1,1,1,1)
        ...
        _CloudsSpeed ("Clouds Speed", Range(-1, 4)) = 0.5
